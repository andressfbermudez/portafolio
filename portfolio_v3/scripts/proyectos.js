...
const proyectos = [
    {
        ...
        imagenes: [
            "./images/proyectos/RESTapiClinicaVoll/listarDoctores.png",
            "./images/proyectos/RESTapiClinicaVoll/crearDoctor.png",
            "./images/proyectos/RESTapiClinicaVoll/eliminarDoctor.png"
        ],
    ...
    },
    {
        ...
        imagenes: [
            "./images/proyectos/ScreenMatchAplicacionWeb/inicio.png",
            "./images/proyectos/ScreenMatchAplicacionWeb/informacionSerie.png",
            "./images/proyectos/ScreenMatchAplicacionWeb/filtradoInformacionSerie.png"
        ],
    ...
    },
    {
        ...
        imagenes: [
            "./images/proyectos/GeneradorFrasesScreenMatch/imagen3.png",
            "./images/proyectos/GeneradorFrasesScreenMatch/imagen1.png",
            "./images/proyectos/GeneradorFrasesScreenMatch/imagen2.png"
        ],
    ...
    },
    {
        ...
        imagenes: [
            "./images/proyectos/ScreenMatch/inicio.png",
            "./images/proyectos/ScreenMatch/episodiosSerie.png",
            "./images/proyectos/ScreenMatch/busquedaPrimeraCoincidenciaEpisodio.png"
        ],
    ...
    },
    {
        ...
        imagenes: [
            "./images/proyectos/BookSmart/inicioBookSmart.png",
            "./images/proyectos/BookSmart/top10Libros.png",
            "./images/proyectos/BookSmart/estadisticas.png"
        ],
    ...
    },
    {
        ...
        imagenes: [
            "./images/proyectos/ConversorMonedas/conversion.png",
            "./images/proyectos/ConversorMonedas/consultasRealizadas.png",
            "./images/proyectos/ConversorMonedas/codigosMonedasPais.png"
        ],
    ...
    },
    {
        ...
        imagenes: [
            "./images/proyectos/AgendaContactos/crearContacto.png",
            "./images/proyectos/AgendaContactos/verContactos.png",
            "./images/proyectos/AgendaContactos/eliminarContacto.png"
        ],
    ...
    },
    {
        ...
        imagenes: [
            "./images/proyectos/CajeroAutomatico/interfazRegistroUsuario.png",
            "./images/proyectos/CajeroAutomatico/interfazRetiro.png",
            "./images/proyectos/CajeroAutomatico/interfazTransaccionFinalizada.png"
        ],
    ...
    },
    {
        ...
        imagenes: [
            "./images/proyectos/Encriptador/encriptadorTexto.png",
            "./images/proyectos/Encriptador/mensajeEncriptado.png",
            "./images/proyectos/Encriptador/mensajeDesencriptado.png"
        ],
    ...
    },
    {
        ...
        imagenes: [
            "./images/proyectos/Calculadora/calculadora.png",
            "./images/proyectos/Calculadora/calculadora2.png",
            "./images/proyectos/Calculadora/calculadoraLinux.png"
        ],
    ...
    },
    {
        ...
        imagenes: [
            "./images/proyectos/Formulario/formulario_interfazPrincipal.png",
            "./images/proyectos/Formulario/formulario_interfazLlenado.png",
            "./images/proyectos/Formulario/formulario_documentoGenerado.png"
        ],
    ...
    },
    {
        ...
        imagenes: [
            "./images/proyectos/Juego/juegoPrincipal.png",
            "./images/proyectos/Juego/juegoInterfazCanvas.png",
            "./images/proyectos/Juego/juegoBatalla.png"
        ],
        link: "https://github.com/Andres-Bermudez/Formulario-Java-Swing",
        ...
        proyectoDiv.innerHTML = `
            ...
            <div class="divBotonDesplegarDescripcion">
                <button class="botonDescripcionProyecto" id="${proyecto.botonId}">Ver descripción del proyecto
                    <img src="./images/iconos/iconoDocumento.png" width="15" height="15" style="padding: 7px;">
                </button>
            </div>
            ...
            <a class="linkProyectoGitHub" href="${proyecto.link}">
                <img src="./images/iconos/iconoGitHub.png" width="33" height="18">Ver proyecto en GitHub
            </a>
        `;
